 ...
 */
package TelaEquacacao;

/**
 *
 * @author João Pires
 */
public class TelaEquacacao extends javax.swing.JFrame {

    /**
     * Creates new form TelaEquacacao
     */
    public TelaEquacacao() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel12.setText("<html> x<sup> 2</sup> + </html>");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaEquacacao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaEquacacao().setVisible(true);
            }
        });
    }
